...
export default {
  ...
  auth: {
    ...
    inAppHint: 'การเข้าสู่ระบบด้วย Google ใช้งานไม่ได้ในแอปนี้',
    inAppOpenBrowser: 'เปิดในเบราว์เซอร์',
    inAppManualHint: 'แตะเมนู ⋯ แล้วเลือก "เปิดในเบราว์เซอร์อื่น" หรือเข้าสู่ระบบด้วยอีเมลด้านล่าง',
  ...
  install: {
    title: 'ติดตั้งแอปเด็กน้อย',
    body: 'เพิ่มลงหน้าจอโฮม เปิดดูแต้มสะสมได้ในแตะเดียว',
    button: 'ติดตั้ง',
    iosHint: 'แตะไอคอนแชร์ แล้วเลือก "เพิ่มไปยังหน้าจอโฮม"',
    lineBody: 'เปิดหน้านี้ในเบราว์เซอร์เพื่อติดตั้งแอป',
